...
class PaymentForm(Form):  # type: ignore
    ...
    expiry_month = IntegerField('Expiry month', [Required(message='Expiry date month is required')])
    expiry_year = IntegerField('Expiry year', [Required(message='Expiry date year is required')])
